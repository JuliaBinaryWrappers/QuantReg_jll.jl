...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import QuantReg_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6615ef03-4b82-5800-9c41-81d3e66fba0f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "QuantReg", artifacts_toml) for e in artifacts["QuantReg"]]
...
if best_platform === nothing
    @debug("Unable to load QuantReg; unsupported platform $(triplet(platform_key_abi()))")
else
