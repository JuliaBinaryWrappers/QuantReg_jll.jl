# Autogenerated wrapper script for QuantReg_jll for x86_64-apple-darwin14-libgfortran3
...
const librqbr_splitpath = ["lib", "librqbr.dylib"]
...
const librqbr = "@rpath/librqbr.dylib"


# Relative path to `librqfnb`
const librqfnb_splitpath = ["lib", "librqfnb.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const librqfnb = "@rpath/librqfnb.dylib"
